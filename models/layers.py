...
class HGraphConvolutionBS(nn.Module):
    ...
    def __init__(self, in_features, out_features, activation=lambda x: x, withbn=False, withloop=False, bias=False,
                 res=False, args=None):
        """
        Initial function.
...
class GraphConvolution(nn.Module):
    ...
    def __init__(self, in_features, out_features, residual=False, variant=False,
        ...
        self.reset_parameters()
        # self.dynamic_adj = Flgc2d(e_n=incidence_e, v_n=incidence_v, init_dist=init_dist)
